...
var MonthView = React.createClass({
    ...
    renderDay: function renderDay(props, date) {
        ...
        var renderDayProps = {
            ...
            onMouseEnter: this.handleHover.bind(this, props, date, dateTimestamp),
            children: dayText
        };
    ...
    handleHover: function handleHover(props, date, timestamp, event) {
        ...
        event.target.value = date;(props.handleHover || emptyFn)(date, event);
    }
});
